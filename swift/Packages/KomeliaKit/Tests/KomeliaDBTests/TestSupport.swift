...
struct TemporaryDatabase {
    ...
    init() throws {
        directory = FileManager.default.temporaryDirectory.appending(path: "KomeliaDBTests-\(UUID().uuidString)")
        database = try KomeliaDatabase(directory: directory)
    }
