...
final class CountingBookApi: KomgaBookApi, @unchecked Sendable {
    ...
    func getOne(_ bookId: KomgaBookId) async throws -> KomeliaBook { fatalError() }
    func getBookList(search: KomgaBookSearch, pageRequest: KomgaPageRequest?) async throws -> Page<KomeliaBook> { fatalError() }
    func getLatestBooks(pageRequest: KomgaPageRequest?) async throws -> Page<KomeliaBook> { fatalError() }
    func getBooksOnDeck(libraryIds: [KomgaLibraryId]?, pageRequest: KomgaPageRequest?) async throws -> Page<KomeliaBook> { fatalError() }
    func getDuplicateBooks(pageRequest: KomgaPageRequest?) async throws -> Page<KomeliaBook> { fatalError() }
    func getBookSiblingPrevious(_ bookId: KomgaBookId) async throws -> KomeliaBook? { fatalError() }
    func getBookSiblingNext(_ bookId: KomgaBookId) async throws -> KomeliaBook? { fatalError() }
