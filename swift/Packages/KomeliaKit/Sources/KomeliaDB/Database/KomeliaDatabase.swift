...
public final class KomeliaDatabase: Sendable {
    public static let appFileName = "komelia.sqlite"
    public static let offlineFileName = "offline.sqlite"

    /// App settings / home screen filters (`komelia.sqlite`).
    ...
    public static func inMemory() throws -> KomeliaDatabase {
        let config = configuration()
        return try KomeliaDatabase(
