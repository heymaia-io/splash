...
/// Port of `snd.komelia.db.OfflineSettings`. May move to KomeliaOffline once that domain lands.
///
/// Ids are plain strings for now (KomeliaDB has no direct KomgaAPI dependency); `userId` is a `KomgaUserId`
