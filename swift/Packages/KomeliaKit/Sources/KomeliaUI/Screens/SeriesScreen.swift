...
public final class SeriesViewModel {
    ...
    public private(set) var books: [KomeliaBook] = []
    ...
    public func markBookRead(_ book: KomeliaBook) async {
        await perform { try await $0.bookApi.markReadProgress(book.id, request: .init(completed: true)) }
    }
    public func markBookUnread(_ book: KomeliaBook) async {
...
struct SeriesScreen: View {
    ...
    private var nextBook: KomeliaBook? {
