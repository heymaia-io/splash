...
public protocol KomgaBookApi: Sendable {
    ...
    func getBooksOnDeck(libraryIds: [KomgaLibraryId]?, pageRequest: KomgaPageRequest?) async throws
        -> Page<KomeliaBook>
    func getDuplicateBooks(pageRequest: KomgaPageRequest?) async throws -> Page<KomeliaBook>
    func getBookSiblingPrevious(_ bookId: KomgaBookId) async throws -> KomeliaBook?
    func getBookSiblingNext(_ bookId: KomgaBookId) async throws -> KomeliaBook?
...
extension KomgaBookApi {
    ...
    public func getLatestBooks() async throws -> Page<KomeliaBook> { try await getLatestBooks(pageRequest: nil) }

    public func getBooksOnDeck(libraryIds: [KomgaLibraryId]? = nil) async throws -> Page<KomeliaBook> {
...
public protocol KomgaReadListApi: Sendable {
    ...
    func getBookSiblingNext(_ readListId: KomgaReadListId, bookId: KomgaBookId) async throws -> KomeliaBook?
    func getBookSiblingPrevious(_ readListId: KomgaReadListId, bookId: KomgaBookId) async throws -> KomeliaBook?
}
