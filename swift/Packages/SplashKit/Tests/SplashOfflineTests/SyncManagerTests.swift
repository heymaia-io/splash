...
final class RecordingBookApi: KomgaBookApi, @unchecked Sendable {
    ...
    func getDuplicateBooks(pageRequest: KomgaPageRequest?) async throws -> Page<SplashBook> { .empty() }
    func getBookSiblingPrevious(_ bookId: KomgaBookId) async throws -> SplashBook? { nil }
    func getBookSiblingNext(_ bookId: KomgaBookId) async throws -> SplashBook? { nil }
