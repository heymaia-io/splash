...
public struct ReaderBooksState: Sendable {
    public var currentBook: SplashBook
    public var currentBookPages: [PageMetadata]
    public var previousBook: SplashBook?
    public var previousBookPages: [PageMetadata]
    public var nextBook: SplashBook?
...
public final class ReaderViewModel {
    ...
    public var currentBook: SplashBook? { books?.currentBook }
    ...
    private func pagesOrEmpty(_ book: SplashBook?) async throws -> [PageMetadata] {
        guard let book else { return [] }
        return try await loadPages(book.id)
    }

    private func nextBook(of id: KomgaBookId) async throws -> SplashBook? {
        switch siblings {
    ...
    private func previousBook(of id: KomgaBookId) async throws -> SplashBook? {
        switch siblings {
